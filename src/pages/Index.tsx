              ...
              <div className="flex w-full">
                <div className="flex flex-col xl:mr-16">
                  ...
                  <p className="text-book-darkGray text-lg mb-8 md:text-xl xl:text-2xl">
                    ...
                    >
                      AsyncAPI
                    </a> (the industry standard) and author of <a className="text-secondary font-bold" href="/shift">Shift</a>. Now, I'm building my next venture in public. Subscribe for an honest look at the whole story: the software architecture, the product strategy, and the human side of building a sustainable business.
                  </p>
